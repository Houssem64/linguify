            ...
            <main className="flex-1 py-12 px-4 md:px-6 lg:px-8">
                <section className="max-w-4xl mx-auto space-y-4">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to golanguify, accessible from <a href="http://www.golanguify.online" target="_blank" rel="noopener noreferrer">http://www.golanguify.online</a></p>
                        </li>
                        <li>
